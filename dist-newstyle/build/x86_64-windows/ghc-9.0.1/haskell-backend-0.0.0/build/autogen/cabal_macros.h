...
/* package haskell-backend-0.0.0 */
#ifndef VERSION_haskell_backend
#define VERSION_haskell_backend "0.0.0"
#endif /* VERSION_haskell_backend */
#ifndef MIN_VERSION_haskell_backend
#define MIN_VERSION_haskell_backend(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_backend */
...
#define CURRENT_PACKAGE_KEY "haskell-backend-0.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "haskell-backend-0.0.0-inplace"
